import { HStack } from "@/components/shared";
...
export const FAQ_PROPS = {
    items: [
        { id:1, "question": "What are the steps to incorporate a startup in India?", "answer": "The steps to incorporate a startup in India typically include business name registration, obtaining Director Identification Number (DIN) and Digital Signature Certificate (DSC), drafting the Memorandum of Association (MoA) and Articles of Association (AoA), and filing the incorporation documents with the Registrar of Companies (RoC)." },
        { id:2, "question": "What are the benefits of registering as a Micro, Small, and Medium Enterprise (MSME)?", "answer": "Registering as an MSME offers benefits such as access to government schemes and subsidies, priority sector lending, protection against delayed payments, eligibility for tax benefits, and enhanced market opportunities." },
        { id:3, "question": "What is the difference between a private limited company and a sole proprietorship for startups?", "answer": "A private limited company is a separate legal entity, providing limited liability protection to its owners and allowing for multiple shareholders, while a sole proprietorship is an unincorporated business owned and operated by a single individual, offering simplicity but without limited liability." },
        { id:4, "question": "Is it mandatory to have a Permanent Account Number (PAN) for incorporating a startup in India?", "answer": "Yes, obtaining a PAN is mandatory for incorporating a startup in India. PAN is required for various tax and regulatory purposes, including opening a bank account, filing tax returns, and conducting financial transactions." },
        { id:5, "question": "Can a foreign national or Non-Resident Indian (NRI) incorporate a startup in India?", "answer": "Yes, foreign nationals and NRIs are allowed to incorporate a startup in India. However, certain conditions and regulatory requirements, such as obtaining the necessary approvals, may apply based on the nature of the business and the foreign national's residency status." },
    ]
};
